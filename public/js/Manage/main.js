...
var UsersTableComponent = /** @class */ (function () {
    function UsersTableComponent(_modal, _user) {
        ...
        this.displayedColumns = ['num', 'regId', 'name', 'phone', 'email', 'state'];
    }
