         ...
         <div class="carousel-inner" role="listbox">
            <div class="item active">
                <div class="carousel-caption" style="margin-top: -5%">
                    <h1 class='text-center' style="font-family: 'Cookie', cursive; font-size: 6em" >rtert {!! $websiteTitle !!}</h1>
                    <p class='text-center'>Make your life easier witdsafaf fidel learning managment</p>
